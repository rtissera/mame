...
/***************************************************************************
    ...
    64-bit ARM (AArch64) back-end for the universal machine language.
...
drcbe_a64::opcode_generate_func drcbe_a64::s_opcode_table[OP_MAX];
...
const drcbe_a64::opcode_table_entry drcbe_a64::s_opcode_table_source[] =
{
	// Compile-time opcodes
	{ uml::OP_HANDLE,  &drcbe_a64::op_handle },     // HANDLE  handle
	{ uml::OP_HASH,    &drcbe_a64::op_hash },       // HASH    mode,pc
	{ uml::OP_LABEL,   &drcbe_a64::op_label },      // LABEL   imm
	{ uml::OP_COMMENT, &drcbe_a64::op_comment },    // COMMENT string
	{ uml::OP_MAPVAR,  &drcbe_a64::op_mapvar },     // MAPVAR  mapvar,value

	// Control Flow Operations
	{ uml::OP_NOP,     &drcbe_a64::op_nop },        // NOP
	{ uml::OP_DEBUG,   &drcbe_a64::op_debug },      // DEBUG   pc
	{ uml::OP_EXIT,    &drcbe_a64::op_exit },       // EXIT    src1[,c]
	{ uml::OP_HASHJMP, &drcbe_a64::op_hashjmp },    // HASHJMP mode,pc,handle
	{ uml::OP_JMP,     &drcbe_a64::op_jmp },        // JMP     imm[,c]
	{ uml::OP_EXH,     &drcbe_a64::op_exh },        // EXH     handle,param[,c]
	{ uml::OP_CALLH,   &drcbe_a64::op_callh },      // CALLH   handle[,c]
	{ uml::OP_RET,     &drcbe_a64::op_ret },        // RET     [c]
	{ uml::OP_CALLC,   &drcbe_a64::op_callc },      // CALLC   func,ptr[,c]
	{ uml::OP_RECOVER, &drcbe_a64::op_recover },    // RECOVER dst,mapvar

	// Internal Register Operations
	{ uml::OP_SETFMOD, &drcbe_a64::op_setfmod },    // SETFMOD src
	{ uml::OP_GETFMOD, &drcbe_a64::op_getfmod },    // GETFMOD dst
	{ uml::OP_GETEXP,  &drcbe_a64::op_getexp },     // GETEXP  dst
	{ uml::OP_GETFLGS, &drcbe_a64::op_getflgs },    // GETFLGS dst[,f]
	{ uml::OP_SAVE,    &drcbe_a64::op_save },       // SAVE    dst
	{ uml::OP_RESTORE, &drcbe_a64::op_restore },    // RESTORE dst

	// Integer Operations
	{ uml::OP_LOAD,    &drcbe_a64::op_load },       // LOAD    dst,base,index,size
	{ uml::OP_LOADS,   &drcbe_a64::op_loads },      // LOADS   dst,base,index,size
	{ uml::OP_STORE,   &drcbe_a64::op_store },      // STORE   base,index,src,size
	{ uml::OP_READ,    &drcbe_a64::op_read },       // READ    dst,src1,spacesize
	{ uml::OP_READM,   &drcbe_a64::op_readm },      // READM   dst,src1,mask,spacesize
	{ uml::OP_WRITE,   &drcbe_a64::op_write },      // WRITE   dst,src1,spacesize
	{ uml::OP_WRITEM,  &drcbe_a64::op_writem },     // WRITEM  dst,src1,spacesize
	{ uml::OP_CARRY,   &drcbe_a64::op_carry },      // CARRY   src,bitnum
	{ uml::OP_SET,     &drcbe_a64::op_set },        // SET     dst,c
	{ uml::OP_MOV,     &drcbe_a64::op_mov },        // MOV     dst,src[,c]
	{ uml::OP_SEXT,    &drcbe_a64::op_sext },       // SEXT    dst,src
	{ uml::OP_ROLAND,  &drcbe_a64::op_roland },     // ROLAND  dst,src1,src2,src3
	{ uml::OP_ROLINS,  &drcbe_a64::op_rolins },     // ROLINS  dst,src1,src2,src3
	{ uml::OP_ADD,     &drcbe_a64::op_add },        // ADD     dst,src1,src2[,f]
	{ uml::OP_ADDC,    &drcbe_a64::op_addc },       // ADDC    dst,src1,src2[,f]
	{ uml::OP_SUB,     &drcbe_a64::op_sub },        // SUB     dst,src1,src2[,f]
	{ uml::OP_SUBB,    &drcbe_a64::op_subc },       // SUBB    dst,src1,src2[,f]
	{ uml::OP_CMP,     &drcbe_a64::op_cmp },        // CMP     src1,src2[,f]
	{ uml::OP_MULU,    &drcbe_a64::op_mulu },       // MULU    dst,edst,src1,src2[,f]
	{ uml::OP_MULS,    &drcbe_a64::op_muls },       // MULS    dst,edst,src1,src2[,f]
	{ uml::OP_DIVU,    &drcbe_a64::op_divu },       // DIVU    dst,edst,src1,src2[,f]
	{ uml::OP_DIVS,    &drcbe_a64::op_divs },       // DIVS    dst,edst,src1,src2[,f]
	{ uml::OP_AND,     &drcbe_a64::op_and },        // AND     dst,src1,src2[,f]
	{ uml::OP_TEST,    &drcbe_a64::op_test },       // TEST    src1,src2[,f]
	{ uml::OP_OR,      &drcbe_a64::op_or },         // OR      dst,src1,src2[,f]
	{ uml::OP_XOR,     &drcbe_a64::op_xor },        // XOR     dst,src1,src2[,f]
	{ uml::OP_LZCNT,   &drcbe_a64::op_lzcnt },      // LZCNT   dst,src[,f]
	{ uml::OP_TZCNT,   &drcbe_a64::op_tzcnt },      // TZCNT   dst,src[,f]
	{ uml::OP_BSWAP,   &drcbe_a64::op_bswap },      // BSWAP   dst,src
	{ uml::OP_SHL,     &drcbe_a64::op_shift<Inst::kIdShl> },        // SHL     dst,src,count[,f]
	{ uml::OP_SHR,     &drcbe_a64::op_shift<Inst::kIdShr> },        // SHR     dst,src,count[,f]
	{ uml::OP_SAR,     &drcbe_a64::op_shift<Inst::kIdSar> },        // SAR     dst,src,count[,f]
	{ uml::OP_ROL,     &drcbe_a64::op_shift<Inst::kIdRol> },        // ROL     dst,src,count[,f]
	{ uml::OP_ROLC,    &drcbe_a64::op_shift<Inst::kIdRcl> },        // ROLC    dst,src,count[,f]
	{ uml::OP_ROR,     &drcbe_a64::op_shift<Inst::kIdRor> },        // ROR     dst,src,count[,f]
	{ uml::OP_RORC,    &drcbe_a64::op_shift<Inst::kIdRcr> },        // RORC    dst,src,count[,f]

	// Floating Point Operations
	{ uml::OP_FLOAD,   &drcbe_a64::op_fload },      // FLOAD   dst,base,index
	{ uml::OP_FSTORE,  &drcbe_a64::op_fstore },     // FSTORE  base,index,src
	{ uml::OP_FREAD,   &drcbe_a64::op_fread },      // FREAD   dst,space,src1
	{ uml::OP_FWRITE,  &drcbe_a64::op_fwrite },     // FWRITE  space,dst,src1
	{ uml::OP_FMOV,    &drcbe_a64::op_fmov },       // FMOV    dst,src1[,c]
	{ uml::OP_FTOINT,  &drcbe_a64::op_ftoint },     // FTOINT  dst,src1,size,round
	{ uml::OP_FFRINT,  &drcbe_a64::op_ffrint },     // FFRINT  dst,src1,size
	{ uml::OP_FFRFLT,  &drcbe_a64::op_ffrflt },     // FFRFLT  dst,src1,size
	{ uml::OP_FRNDS,   &drcbe_a64::op_frnds },      // FRNDS   dst,src1
	{ uml::OP_FADD,    &drcbe_a64::op_fadd },       // FADD    dst,src1,src2
	{ uml::OP_FSUB,    &drcbe_a64::op_fsub },       // FSUB    dst,src1,src2
	{ uml::OP_FCMP,    &drcbe_a64::op_fcmp },       // FCMP    src1,src2
	{ uml::OP_FMUL,    &drcbe_a64::op_fmul },       // FMUL    dst,src1,src2
	{ uml::OP_FDIV,    &drcbe_a64::op_fdiv },       // FDIV    dst,src1,src2
	{ uml::OP_FNEG,    &drcbe_a64::op_fneg },       // FNEG    dst,src1
	{ uml::OP_FABS,    &drcbe_a64::op_fabs },       // FABS    dst,src1
	{ uml::OP_FSQRT,   &drcbe_a64::op_fsqrt },      // FSQRT   dst,src1
	{ uml::OP_FRECIP,  &drcbe_a64::op_frecip },     // FRECIP  dst,src1
	{ uml::OP_FRSQRT,  &drcbe_a64::op_frsqrt },     // FRSQRT  dst,src1
	{ uml::OP_FCOPYI,  &drcbe_a64::op_fcopyi },     // FCOPYI  dst,src
	{ uml::OP_ICOPYF,  &drcbe_a64::op_icopyf }      // ICOPYF  dst,src
};
...
drcbe_a64::be_parameter::be_parameter(drcbe_a64 &drcbe, const parameter &param, uint32_t allowed)
{
	int regnum;
...
inline Gp drcbe_a64::be_parameter::select_register(Gp defreg) const
{
...
inline Xmm drcbe_a64::be_parameter::select_register(Xmm defreg) const
{
...
template <typename T> T drcbe_a64::be_parameter::select_register(T defreg, be_parameter const &checkparam) const
{
	if (*this == checkparam)
		return defreg;
...
template <typename T> T drcbe_a64::be_parameter::select_register(T defreg, be_parameter const &checkparam, be_parameter const &checkparam2) const
{
...
inline void drcbe_a64::normalize_commutative(be_parameter &inner, be_parameter &outer)
{
...
inline int32_t drcbe_a64::offset_from_rbp(const void *ptr) const
{
	const int64_t delta = reinterpret_cast<const uint8_t *>(ptr) - m_rbpvalue;
	if (int32_t(delta) != delta)
		throw emu_fatalerror("drcbe_a64::offset_from_rbp: delta out of range");
...
inline Gp drcbe_a64::get_base_register_and_offset(Assembler &a, void *target, Gp const &reg, int32_t &offset)
{
...
inline void drcbe_a64::smart_call_r64(Assembler &a, x86code *target, Gp const &reg)
{
...
inline void drcbe_a64::smart_call_m64(Assembler &a, x86code **target)
{
	const int64_t delta = *target - (x86code *)(a.code()->baseAddress() + a.offset() + 5);
	if (short_immediate(delta))
		a.call(imm(*target));                                                           // call  *target
...
//-------------------------------------------------
//  drcbe_a64 - constructor
//-------------------------------------------------

drcbe_a64::drcbe_a64(drcuml_state &drcuml, device_t &device, drc_cache &cache, uint32_t flags, int modes, int addrbits, int ignorebits)
		...
		m_near(*(near_state *)cache.alloc_near(sizeof(m_near)))
{
	...
	{
		std::string filename = std::string("drcbea64_").append(device.shortname()).append(".asm");
		m_log = x86log_create_context(filename.c_str());
		m_log_asmjit = fopen(std::string("drcbea64_asmjit_").append(device.shortname()).append(".asm").c_str(), "w");
	}
}


//-------------------------------------------------
//  ~drcbe_a64 - destructor
//-------------------------------------------------
...
size_t drcbe_a64::emit(CodeHolder &ch)
{
	Error err;
...
int drcbe_a64::execute(code_handle &entry)
{
...
//-------------------------------------------------
//  drcbea64_generate - generate code
//-------------------------------------------------

void drcbe_a64::generate(drcuml_block &block, const instruction *instlist, uint32_t numinst)
{
...
bool drcbe_a64::hash_exists(uint32_t mode, uint32_t pc)
{
...
void drcbe_a64::get_info(drcbe_info &info)
{
...
void drcbe_a64::alu_op_param(Assembler &a, Inst::Id const opcode, Operand const &dst, be_parameter const &param, std::function<bool(Assembler &a, Operand const &dst, be_parameter const &src)> optimize)
{
...
void drcbe_a64::shift_op_param(Assembler &a, Inst::Id const opcode, Operand const &dst, be_parameter const &param)
{
	Operand shift = cl;
	if (param.is_immediate())
...
void drcbe_a64::mov_reg_param(Assembler &a, Gp const &reg, be_parameter const &param, bool const keepflags)
{
	if (param.is_immediate())
	{
...
void drcbe_a64::mov_param_reg(Assembler &a, be_parameter const &param, Gp const &reg)
{
...
void drcbe_a64::mov_mem_param(Assembler &a, Mem const &mem, be_parameter const &param)
{
...
void drcbe_a64::movsx_r64_p32(Assembler &a, Gp const &reg, be_parameter const &param)
{
	if (param.is_immediate())
	{
...
void drcbe_a64::mov_r64_imm(Assembler &a, Gp const &reg, uint64_t const imm)
{
	if (u32(imm) == imm)
		a.mov(reg.r32(), imm);
	else if (s32(imm) == imm)
...
void drcbe_a64::movss_r128_p32(Assembler &a, Xmm const &reg, be_parameter const &param)
{
	assert(!param.is_immediate());
	if (param.is_memory())
...
void drcbe_a64::movss_p32_r128(Assembler &a, be_parameter const &param, Xmm const &reg)
{
	assert(!param.is_immediate());
	if (param.is_memory())
...
void drcbe_a64::movsd_r128_p64(Assembler &a, Xmm const &reg, be_parameter const &param)
{
	assert(!param.is_immediate());
	if (param.is_memory())
...
void drcbe_a64::movsd_p64_r128(Assembler &a, be_parameter const &param, Xmm const &reg)
{
	assert(!param.is_immediate());
	if (param.is_memory())
...
void drcbe_a64::debug_log_hashjmp(offs_t pc, int mode)
{
...
void drcbe_a64::debug_log_hashjmp_fail()
{
	printf("  (FAIL)\n");
}
...
void drcbe_a64::op_handle(Assembler &a, const instruction &inst)
{
...
void drcbe_a64::op_hash(Assembler &a, const instruction &inst)
{
	assert_no_condition(inst);
	assert_no_flags(inst);
...
void drcbe_a64::op_label(Assembler &a, const instruction &inst)
{
	assert_no_condition(inst);
	assert_no_flags(inst);
	assert(inst.numparams() == 1);
...
void drcbe_a64::op_comment(Assembler &a, const instruction &inst)
{
	assert_no_condition(inst);
	assert_no_flags(inst);
	assert(inst.numparams() == 1);
...
void drcbe_a64::op_mapvar(Assembler &a, const instruction &inst)
{
	assert_no_condition(inst);
	assert_no_flags(inst);
	assert(inst.numparams() == 2);
...
void drcbe_a64::op_nop(Assembler &a, const instruction &inst)
{
	// nothing
}
...
void drcbe_a64::op_debug(Assembler &a, const instruction &inst)
{
...
void drcbe_a64::op_exit(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
...
void drcbe_a64::op_hashjmp(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_jmp(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_any_condition(inst);
...
void drcbe_a64::op_exh(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_any_condition(inst);
...
void drcbe_a64::op_callh(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_any_condition(inst);
...
void drcbe_a64::op_ret(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_any_condition(inst);
...
void drcbe_a64::op_callc(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_any_condition(inst);
...
void drcbe_a64::op_recover(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_setfmod(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_getfmod(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_getexp(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_getflgs(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_save(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_restore(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4);
	assert_no_condition(inst);
...
void drcbe_a64::op_load(Assembler &a, const instruction &inst)
{
	// validate instruction
...
void drcbe_a64::op_loads(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_store(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_read(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_readm(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_write(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_writem(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_carry(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_set(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_any_condition(inst);
...
void drcbe_a64::op_mov(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_any_condition(inst);
...
void drcbe_a64::op_sext(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_roland(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_rolins(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_add(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_addc(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_sub(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_subc(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_cmp(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_mulu(Assembler &a, const instruction &inst)
{
...
void drcbe_a64::op_muls(Assembler &a, const instruction &inst)
{
	uint8_t zsflags = inst.flags() & (FLAG_Z | FLAG_S);
	uint8_t vflag =  inst.flags() & FLAG_V;
...
void drcbe_a64::op_divu(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_divs(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_and(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_test(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_or(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_xor(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_lzcnt(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_tzcnt(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_bswap(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
template <Inst::Id Opcode> void drcbe_a64::op_shift(Assembler &a, const uml::instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fload(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fstore(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fread(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fwrite(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fmov(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_any_condition(inst);
...
void drcbe_a64::op_ftoint(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_ffrint(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_ffrflt(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_frnds(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fadd(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fsub(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fcmp(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fmul(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fdiv(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fneg(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fabs(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fsqrt(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_frecip(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_frsqrt(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_fcopyi(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
...
void drcbe_a64::op_icopyf(Assembler &a, const instruction &inst)
{
	// validate instruction
	assert(inst.size() == 4 || inst.size() == 8);
	assert_no_condition(inst);
